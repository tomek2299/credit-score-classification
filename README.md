...
**Dataset:** [Credit Score Classification on Kaggle](https://www.kaggle.com/datasets/parisrohan/credit-score-classification)
(use `train.csv`). It is not included in this repo due to size — download it from the link
and place `train.csv` next to the notebook before running.
...
> `train.csv` is **not** included (see Dataset link above). Download it from Kaggle and put
> it in the same folder as the notebook.
...
Download `train.csv` from the [Kaggle dataset](https://www.kaggle.com/datasets/parisrohan/credit-score-classification)
and place it in the same folder as the notebook before running.
